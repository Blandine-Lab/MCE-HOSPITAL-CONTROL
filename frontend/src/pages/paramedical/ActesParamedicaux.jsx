    ...
    <div>
      <div style={{ 
        ...
        <h1 style={{ fontSize: '28px', color: '#0f172a', display: 'flex', alignItems: 'center', gap: '12px' }}>
          <FaClipboardList style={{ color: '#34d399' }} /> Actes paramdicaux
        </h1>
        <button
      ...
      <div style={{ marginBottom: '20px' }}>
        <div style={{ display: 'flex', alignItems: 'center', backgroundColor: 'white', borderRadius: '8px', border: '1px solid #e2e8f0', padding: '4px 12px' }}>
          ...
          <input
            type="text"
            placeholder="Rechercher par code, nom ou catgorie..."
            value={searchTerm}
      ...
      {showForm && (
        <div style={{ 
          ...
          <h3 style={{ marginTop: 0 }}>{editingActe ? 'Modifier l\'acte' : 'Nouvel acte paramdical'}</h3>
          <form onSubmit={handleSubmit} style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
            ...
            <div>
              <label style={{ display: 'block', marginBottom: '4px', fontWeight: '500', color: '#334155' }}>Catgorie</label>
              <select
            ...
            <div>
              <label style={{ display: 'block', marginBottom: '4px', fontWeight: '500', color: '#334155' }}>Dure estime (min)</label>
              <input
                type="number"
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse' }}>
          <thead style={{ backgroundColor: '#f1f5f9' }}>
            <tr>
              ...
              <th style={{ padding: '14px 20px', textAlign: 'left', fontWeight: '600', color: '#475569' }}>Catgorie</th>
              <th style={{ padding: '14px 20px', textAlign: 'left', fontWeight: '600', color: '#475569' }}>Dure</th>
