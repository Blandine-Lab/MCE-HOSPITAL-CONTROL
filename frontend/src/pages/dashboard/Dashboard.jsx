  ...
  return (
    <div style={{ 
      ...
      <div style={{
        ...
        />
        <StatCard icon={FaEuroSign} label="CA (période)" value={`${stats.ca.toLocaleString()} €`} color="#22c55e" />
        <StatCard icon={FaMoneyBillWave} label="Impayés" value={`${stats.impayes.toLocaleString()} €`} color="#ef4444" />
        <StatCard icon={FaEuroSign} label="CA aujourd'hui" value={`${todayRevenue.toFixed(2)} €`} color="#22c55e" />
              ...
              <tbody>
                {lastFactures.map((f, idx) => (
                  <tr key={idx} style={{ borderBottom: '1px solid #f1f5f9' }}>
                    ...
                    <td style={{ padding: '10px', textAlign: 'right' }}>{parseFloat(f.montant_total).toFixed(2)} €</td>
                    <td style={{ padding: '10px', textAlign: 'right' }}>{parseFloat(f.montant_paye || 0).toFixed(2)} €</td>
