  ...
  return (
    <div style={{ padding: '24px', maxWidth: '1200px', margin: '0 auto' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '24px' }}>
        ...
        <h1 style={{ margin: 0, color: '#0f172a' }}>Sécurité & Conformité</h1>
      </div>
      ...
      <div style={{ marginBottom: '24px' }}>
        ...
        >
          <FaUserCog /> Administration (Gestion des utilisateurs & rôles)
        </Link>
      </div>

      {/* ---- Menu de navigation du module Sécurité ---- */}
      <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap', marginBottom: '24px', borderBottom: '1px solid #e2e8f0', paddingBottom: '16px' }}>
        ...
        <Link to="/security/roles" style={{ color: '#64748b', textDecoration: 'none' }}>👥 Rôles & Permissions</Link>
        ...
        <Link to="/security/sessions" style={{ color: '#64748b', textDecoration: 'none' }}>🖥️ Sessions actives</Link>
        <Link to="/security/tentatives" style={{ color: '#64748b', textDecoration: 'none' }}>⚠️ Tentatives connexion</Link>
      </div>
