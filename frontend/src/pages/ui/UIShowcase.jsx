// src/pages/ui/UIShowcase.jsx – Sections colorées distinctes
...
const UIShowcase = () => {
  ...
  const showNotification = (type) => {
    alert(`Notification ${type} (démonstration)`);
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50/30 p-6 md:p-10 font-sans antialiased">
      <div className="max-w-6xl mx-auto">
        ...
        <header className="text-center mb-12 relative">
          <div className="inline-block bg-white/70 backdrop-blur-sm px-8 py-4 rounded-2xl shadow-sm border border-white/50">
            ...
            <p className="text-gray-500 text-sm md:text-base mt-1 font-medium tracking-wide">
              Bibliothèque de composants · Design System v2
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <section className="bg-blue-50/80 rounded-2xl shadow-lg shadow-blue-100/50 p-6 border border-blue-100/60 hover:shadow-xl transition-shadow duration-300">
            ...
            <div className="flex flex-wrap gap-3 items-center">
              ...
              <button className="px-5 py-2.5 rounded-xl bg-gradient-to-r from-emerald-500 to-emerald-600 text-white text-sm font-medium shadow-md shadow-emerald-200 hover:shadow-emerald-300 hover:scale-105 transition-all duration-200">Succès</button>
              ...
              <button className="px-5 py-2.5 rounded-xl text-gray-500 text-sm font-medium hover:bg-gray-100 hover:scale-105 transition-all duration-200">Fantôme</button>
          ...
          <section className="bg-emerald-50/80 rounded-2xl shadow-lg shadow-emerald-100/50 p-6 border border-emerald-100/60 hover:shadow-xl transition-shadow duration-300">
            <h2 className="text-lg font-semibold text-gray-700 flex items-center gap-2 mb-4">
              <span className="bg-emerald-200 text-emerald-700 p-1.5 rounded-lg text-sm">🏷️</span> Badges
            </h2>
            <div className="flex flex-wrap gap-2">
              ...
              <span className="px-3.5 py-1.5 rounded-full text-xs font-semibold bg-emerald-100 text-emerald-700 shadow-sm">Succès</span>
          ...
          <section className="lg:col-span-2 bg-violet-50/80 rounded-2xl shadow-lg shadow-violet-100/50 p-6 border border-violet-100/60 hover:shadow-xl transition-shadow duration-300">
            <h2 className="text-lg font-semibold text-gray-700 flex items-center gap-2 mb-4">
              <span className="bg-violet-200 text-violet-700 p-1.5 rounded-lg text-sm">✏️</span> Champs de saisie
            </h2>
          ...
          {/* SECTION : Cartes métriques - fond rose clair (occupe 2 colonnes) */}
          <section className="lg:col-span-2 bg-rose-50/80 rounded-2xl shadow-lg shadow-rose-100/50 p-6 border border-rose-100/60 hover:shadow-xl transition-shadow duration-300">
            <h2 className="text-lg font-semibold text-gray-700 flex items-center gap-2 mb-4">
              <span className="bg-rose-200 text-rose-700 p-1.5 rounded-lg text-sm">📊</span> Cartes métriques
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
              ...
              <div className="bg-white/70 backdrop-blur-sm p-5 rounded-xl border border-violet-200/60 shadow-sm group hover:shadow-md hover:-translate-y-0.5 transition-all duration-200">
                <div className="flex items-center gap-4">
                  <div className="bg-violet-100 p-3 rounded-xl text-2xl">⚙️</div>
                  <div>
                    <p className="text-xs font-semibold text-violet-600 uppercase tracking-wider">Paramètres</p>
          ...
          <section className="bg-cyan-50/80 rounded-2xl shadow-lg shadow-cyan-100/50 p-6 border border-cyan-100/60 hover:shadow-xl transition-shadow duration-300 flex flex-col gap-6">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-3">
                <button className="px-4 py-2 rounded-xl bg-emerald-500 text-white text-sm font-medium shadow-sm shadow-emerald-200 hover:shadow-emerald-300 hover:scale-105 transition-all duration-200 flex items-center gap-1.5" onClick={() => showNotification('Succès')}>
                  <span>✅</span> Succès
                </button>
          ...
          >
            ...
            >
              ...
              <p className="text-gray-600 mb-6">
                Ceci est une modale de démonstration. Cliquez en dehors ou sur le bouton pour la fermer.
              </p>
        ...
        <footer className="text-center text-sm text-gray-400 mt-12 pt-6 border-t border-gray-200/60">
          <p>© 2026 Hôpital · Interface Utilisateur (UI/UX) v2.0 — Tous droits réservés</p>
          <p className="mt-1 text-xs text-gray-300">Conçu avec ❤️ et Tailwind CSS</p>
        </footer>
