            ...
            <ToastProvider>
              ...
              <Routes>
                ...
                <Route element={<Layout />}>
                  ...
                  {/* Page d'accueil (Home) �FC� visible par tous les utilisateurs connectés */}
                  <Route
                    path="/"
                    element={
                      <ProtectedRoute>
                  ...
                  {/* ============================================================ */}
                  {/* MODULE MÉDICAL (DME) �FC� AVEC NOUVELLES ROUTES                 */}
                  {/* ============================================================ */}
                  <Route
                    path="/medical"
                    element={
                  ...
                  {/* ============================================================ */}
                  {/* MODULE RH (RESSOURCES HUMAINES & PLANNING) �FC� ROUTES COMPLÈTES */}
                  {/* ============================================================ */}
                  <Route
                    path="/rh"
                    element={
